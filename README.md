...
See [the announcement](https://blog.abp.io/abp/Introducing-the-NPEICloud-Project) post for more info.

Live demo is on https://www.NPEICloud.com/
...
- Clone the repository ( [NPEICloud](https://github.com/abpframework/NPEICloud) )
...
- [x] Deployment to azure k8s ✔️ (https://NPEICloud.com)
### Version 2.0
