...
namespace NPEICloud.AuthServer;
...
public class NPEICloudAuthServerModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        context.Services
            ...
            .SetApplicationName("NPEICloud-AuthServer");
        ...
        if (hostingEnvironment.IsDevelopment())
        {
            ...
            {
                options.FileSets.ReplaceEmbeddedByPhysical<NPEICloudSharedLocalizationModule>(Path.Combine(
                    hostingEnvironment.ContentRootPath,
                    $"..{Path.DirectorySeparatorChar}..{Path.DirectorySeparatorChar}..{Path.DirectorySeparatorChar}..{Path.DirectorySeparatorChar}shared{Path.DirectorySeparatorChar}NPEICloud.Shared.Localization"));
            });
        }
    }
    ...
    {
        const string fileName = "NPEICloud-authserver.pfx";
