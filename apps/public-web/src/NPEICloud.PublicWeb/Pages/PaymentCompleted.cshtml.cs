...
public class PaymentCompletedModel : AbpPageModel
{
    ...
    {
        if (!HttpContext.Request.Cookies.TryGetValue(NPEICloudPaymentConsts.PaymentMethodCookie,
        ...
        if (IsSuccessful)
        {
            ...
            HttpContext.Response.Cookies.Delete(NPEICloudPaymentConsts.PaymentMethodCookie);
