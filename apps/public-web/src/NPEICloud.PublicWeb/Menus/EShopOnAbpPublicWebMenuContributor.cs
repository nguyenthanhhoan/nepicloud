...
{
    public class NPEICloudPublicWebMenuContributor : IMenuContributor
    {
        private readonly IConfiguration _configuration;

        public NPEICloudPublicWebMenuContributor(IConfiguration configuration)
        {
        ...
        {
            var l = context.GetLocalizer<NPEICloudResource>();

            // Home
            context.Menu.AddItem(
                new ApplicationMenuItem(
                    NPEICloudPublicWebMenus.HomePage,
                    l["Menu:Home"],
                    "~/",
                    icon: "fa fa-home",
                    order: 0
        ...
        private Task ConfigureUserMenuAsync(MenuConfigurationContext context)
        {
            ...
            var eShopResource = context.GetLocalizer<NPEICloudResource>();
