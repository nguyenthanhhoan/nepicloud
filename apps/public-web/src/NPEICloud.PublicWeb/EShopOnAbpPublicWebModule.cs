...
using NPEICloud.PaymentService.PaymentMethods;
using NPEICloud.PublicWeb.AnonymousUser;
using NPEICloud.PublicWeb.Components.Toolbar.Cart;
using NPEICloud.PublicWeb.Menus;
using NPEICloud.PublicWeb.PaymentMethods;
...
[DependsOn(
    ...
    typeof(NPEICloudSharedLocalizationModule),
...
public class NPEICloudPublicWebModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
        {
            options.AddAssemblyResource(
                typeof(NPEICloudResource),
                typeof(NPEICloudPublicWebModule).Assembly
            );
        });
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        context.Services.AddAutoMapperObjectMapper<NPEICloudPublicWebModule>();
        Configure<AbpAutoMapperOptions>(options => { options.AddMaps<NPEICloudPublicWebModule>(validate: true); });
        ...
        Configure<AbpDistributedCacheOptions>(options => { options.KeyPrefix = "NPEICloud:"; });
        ...
        context.Services
            ...
            .SetApplicationName("NPEICloud-PublicWeb");

        Configure<AbpNavigationOptions>(options =>
        {
            options.MenuContributors.Add(new NPEICloudPublicWebMenuContributor(configuration));
        });

        Configure<AbpToolbarOptions>(options =>
        {
            options.Contributors.Add(new NPEICloudPublicWebToolbarContributor());
        });
    ...
    private void ConfigureBasketHttpClient(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<NPEICloudPublicWebModule>();
        });
    }

    private void ConfigurePayment(IConfiguration configuration)
    {
        Configure<NPEICloudPublicWebPaymentOptions>(options =>
        {
    ...
    {
        var logger = httpContext.RequestServices.GetRequiredService<ILogger<NPEICloudPublicWebModule>>();
