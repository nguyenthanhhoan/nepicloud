...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NPEICloud.OrderingService.Buyers.Buyer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("NPEICloud.OrderingService.Buyers.PaymentType", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer")
                        .HasDefaultValue(1);
            ...
            modelBuilder.Entity("NPEICloud.OrderingService.Orders.OrderStatus", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer")
                        .HasDefaultValue(1);
            ...
            modelBuilder.Entity("NPEICloud.OrderingService.Buyers.Buyer", b =>
                {
                    b.HasOne("NPEICloud.OrderingService.Buyers.PaymentType", "PaymentType")
                        .WithMany()
            ...
            modelBuilder.Entity("NPEICloud.OrderingService.Orders.Order", b =>
                {
                    b.HasOne("NPEICloud.OrderingService.Buyers.Buyer", null)
                        .WithMany()
                        .HasForeignKey("BuyerId");

                    b.HasOne("NPEICloud.OrderingService.Orders.OrderStatus", "OrderStatus")
                        .WithMany()
