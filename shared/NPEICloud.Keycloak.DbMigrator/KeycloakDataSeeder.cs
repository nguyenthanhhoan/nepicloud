...
public class KeyCloakDataSeeder : IDataSeedContributor, ITransientDependency
{
    ...
    private async Task CreateAdministrationClientAsync()
    {
        ...
        if (administrationClient == null)
        {
            ...
            await AddOptionalClientScopesAsync(
                "NPEICloud_AdministrationService",
                new List<string>
                {
                    "IdentityService"
                }
            ...
            var insertedClient =
                (await _keycloakClient.GetClientsAsync(_keycloakOptions.RealmName, clientId: "NPEICloud_AdministrationService"))
                .First();
    ...
    {
        var cmsKitClient =
            (await _keycloakClient.GetClientsAsync(_keycloakOptions.RealmName, clientId: "NPEICloud_CmskitService"))
            .FirstOrDefault();
