...
Export-PfxCertificate -Cert $rootCA -FilePath NPEICloud-root-cert.pfx -Password $password | Out-Null
...
Export-Certificate -Cert $rootCA -FilePath NPEICloud-root-cert.cer -Type CERT | Out-Null
